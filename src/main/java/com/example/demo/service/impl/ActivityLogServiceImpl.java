...
public class ActivityLogServiceImpl implements ActivityLogService {
    ...
    public ActivityLog logActivity(Long userId, Long typeId, ActivityLog log) {
        ...
        ActivityType type = typeRepository.findById(typeId)
                .orElseThrow(() -> new ResourceNotFoundException("Category not found")); // Using "Category not found" or Type not found based on test helper ambiguity, but usually specific
